                    ...
                    <aside class="widget widget_text">
                        <div class="textwidget">
                            <div class="pbmit-footer-logo">
                                <img src="{{ asset ('landing/images/logo-politani-1-black.png') }}" alt="">
                            </div>
                            <div class="pbmit-footer-text">
                                Sidomulyo adalah salah satu desa di Kecamatan Anggana, Kabupaten Kutai Kartanegara, Provinsi Kalimantan Timur, Indonesia.
                            </div>
