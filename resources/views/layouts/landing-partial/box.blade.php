            ...
            <div class="col-md-6 col-lg-4 position-relative">
                ...
                <div class="inner-box_style inner-box_1">
                    ...
                    <ul class="pbmit-timelist-list">
                        <li>
                            <span class="pbmit-timelist-li-title">Senin – Jumat</span>
                            <span class="pbmit-timelist-li-value">08:00 - 16:00</span>
                        </li>
                        <li>
                            <span class="pbmit-timelist-li-title">Sabtu</span>
                            <span class="pbmit-timelist-li-value">08:00 - 12:00</span>
                        </li>
                        <li>
                            <span class="pbmit-timelist-li-title">Minggu</span>
                            <span class="pbmit-timelist-li-value">LIBUR</span>
                        </li>
                        <li>
                            <span class="pbmit-timelist-li-title">Layanan Online Tersedia 24/7</span>
                ...
                <div class="inner-box_style inner-box_2">
                    ...
                    <a class="pbmit-btn pbmit-btn-outline" target="_BLANK" href="https://maps.app.goo.gl/b2bxMor6kgrum5f2A">
                        <span class="pbmit-button-content-wrapper">
                            ...
                            <span class="pbmit-button-text">Buka Google Map</span>
                        </span>
                    </a>
                </div>
            </div>
