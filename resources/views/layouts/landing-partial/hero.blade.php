        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div class="pbmit-slider-item">
                    <div class="pbmit-slider-bg" style="background-image: url({{ URL::asset('landing/images/slider-img/konten.jpg') }});""></div>
                    <div class="container">
                                    ...
                                    <div class="pbmit-button transform-bottom transform-delay-3">
                                        <a class="pbmit-btn" href="">
                                            <span class="pbmit-button-content-wrapper">
                                                ...
                                                <span class="pbmit-button-text">Layanan Surat</span>
                                            </span>
                                        </a>
            ...
            <div class="swiper-slide">
                <div class="pbmit-slider-item">
                    <div class="pbmit-slider-bg" style="background-image: url({{ URL::asset('landing/images/slider-img/kantor.jpg') }});""></div>
                    <div class="container">
                        <div class="row text-center">
                            <div class="col-md-12">
                                <div class="pbmit-slider-content">
            ...
            <div class="swiper-slide">
                <div class="pbmit-slider-item">
                    <div class="pbmit-slider-bg" style="background-image: url({{ URL::asset('landing/images/slider-img/gerbang.jpg') }});"></div>
                    <div class="container">
                        <div class="row text-center">
                            <div class="col-md-12">
                                <div class="pbmit-slider-content">
