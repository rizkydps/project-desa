                    ...
                    {{-- <div class="appointment_box"> --}}
                        ...
                        <form action="{{ route('formulir.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-container" id="form-1">
                                <div class="formulir_box">
                                    <h4 class="text-center mb-3">Surat Keterangan Domisili</h4>
                                    <div class="row">
                                        <div class="lite">Informasi Pemohon</div>

                                        <div class="col-md-6">
                                            <label for="formFile" class="form-label">Nama Pemohon :</label>
                                            <input type="text" class="form-control" placeholder="Masukan Nama Pemohon" name="name_pemohon">
                                        </div>
                    
                                        <div class="col-md-6">
                                            <label for="formFile" class="form-label">Nomor Whatsapp Pemohon :</label>

                                            <input type="tel" class="form-control" placeholder="Masukan Nomor Whatsapp"
                                                name="whatsapp">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row ">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select form-control" name="warganegara"
                                                aria-label="Default select example">
                                                <option disabled selected> Pilih Status Warganegara</option>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label">Pilih Status Pernikahan:</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" placeholder="Masukan Alamat Saat Ini"
                                                name="alamat">
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <div class="formulir_box mt-5">
                                    <h4 class="text-center mb-3">Informasi Surat</h4>
                                    <div class="text-kecil">Syarat Pengajuan :</div>
                                    <ul>
                                        <li>Isikan formulir berikut dengan benar.</li>
                                        <li>Siapkan Berkas Berikut:</li>
                                    </ul>
                                    ...
                                    <div class="text-kecil">Pengambilan Surat :</div>
                                    <ul>
                                        <li>Silahkan menunggu konfirmasi dari admin desa.</li>
                                        <li>Surat daat diambil di kantor Desa di jam kerja.</li>
                                        <li>Berkas yang harus dibawa saat pengambilan:</li>
                                    </ul>
                                    <ol>
                            ...
                            <div class="form-container" id="form-2">
                                <div class="formulir_box">
                                    <h4 class="text-center mb-3">Surat Keterangan Pindah</h4>
                                    <div class="row">
                                        <div class="lite">Informasi Pemohon</div>
                            ...
                            <div class="form-container" id="form-3">
                                <div class="formulir_box">
                                    <h4 class="text-center mb-3">Surat Pengantar Nikah</h4>
                                    <div class="row">
                                        <div class="lite">Informasi Pemohon</div>
                            ...
                            <div class="form-container" id="form-4">
                                <div class="formulir_box">
                                    <h4 class="text-center mb-3">Surat Keterangan Kematian</h4>
                                    <div class="row">
                                        <div class="lite">Informasi Pemohon</div>
                            ...
                            <div class="form-container" id="form-5">
                                <div class="formulir_box">
                                    <h4 class="text-center mb-3">Surat Keterangan Kelahiran</h4>
                                    <div class="row">
                                        <div class="lite">Informasi Pemohon</div>
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="time" class="form-control" placeholder="Jam Lahir"
                                                name="jam_lahir">
                            ...
                            <div class="form-container" id="form-6">
                                <div class="formulir_box">
                                    <h4 class="text-center mb-3">Surat Ijin Keramaian</h4>
                                    <div class="row">
                                        <div class="lite">Informasi Pemohon</div>
                            ...
                            <div class="form-container" id="form-7">
                                <div class="formulir_box">
                                    <h4 class="text-center mb-3">Surat Keterangan Tidak Mampu</h4>
                                    <div class="row">
                                        <div class="lite">Informasi Pemohon</div>
                            ...
                            <div class="form-container" id="form-8">
                                <div class="formulir_box">
                                    <h4 class="text-center mb-3">Surat Keterangan Usaha</h4>
                                    <div class="row">
                                        <div class="lite">Informasi Pemohon</div>
                            ...
                            <div class="form-container" id="form-9">
                                <div class="formulir_box">
                                    <h4 class="text-center mb-3">Surat Kehilangan</h4>
                                    <div class="row">
                                        <div class="lite">Informasi Pemohon</div>
                            ...
                            <div class="form-container" id="form-10">
                                <div class="formulir_box">
                                    <h4 class="text-center mb-3">Surat Keterangan Orang Yang Sama</h4>
                                    <div class="row">
                                        <div class="lite">Informasi Pemohon</div>
                            ...
                            <div class="form-container" id="form-11">
                                <div class="formulir_box">
                                    <h4 class="text-center mb-3">Surat Rekomendasi</h4>
                                    <div class="row">
                                        <div class="lite">Informasi Pemohon</div>
