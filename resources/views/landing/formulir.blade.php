                    ...
                    <div class="appointment_box">
                        ...
                        <form action="{{ route('formulir.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-container" id="form-1">
								...
								<div class="col-md-6">
									<select class="form-select form-control" name="warganegara" aria-label="Default select example">
								...
								<div class="col-md-6">
									<select class="form-select form-control" name="agama" aria-label="Default select example">
								...
								<div class="col-md-6">
									<select class="form-select form-control" name="status_pernikahan" aria-label="Default select example">
    ...
    <script>
      let formSelector = document.getElementById("form-selector");
            ...
            formContainers.forEach(container => {
                if (container.id === id) {
                    ...
                    container.querySelectorAll("input, select").forEach(element => {
                        element.removeAttribute("disabled"); // Enable all inputs and selects in the active form container
                    });
                } else {
                    container.style.display = "none"; // Hide other form containers
                    container.querySelectorAll("input, select").forEach(element => {
                        element.setAttribute("disabled", true); // Disable all inputs and selects in other form containers
                    });
                }
            });
        }
        ...
        formContainers.forEach(container => {
            ...
            container.querySelectorAll("input, select").forEach(element => {
            element.setAttribute("disabled", true); // Disable all inputs and selects in all form containers
        });
    });
}
