...
<body onload="window.print()">
    <div class="surat-wrapper">
        ...
        <div class="head-1">SURAT KETERANGAN USAHA</div>
        ...
        <div>kecamatan anggana desa sidomulyo dengan ini menyatakan:</div>
        ...
        <div>Benar yang namanya di atas adalah penduduk anggana sidomulyo. Menurut amatan kami benarbahwa yang bersangkutan mempumyai usaha tambang emas</div>
        <div id="data-lurah-pengaju">
        <div>Surat keterangan ini kami keluarkan untuk permohonan modal usaha.</div>
         <div>Demikian surat keterangan ini kami buat untuk dapat dipergunakan seperlunya</div>   
