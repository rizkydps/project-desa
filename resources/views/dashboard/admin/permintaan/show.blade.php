                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form action="{{ route('dashboard.surat.update', $surat->id) }}" method="POST">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="name" value="{{ $surat->name }}">
                            </div>
                            </div>
                            <a href="{{ route('dashboard.surat.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i
