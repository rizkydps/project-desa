        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <div class="row mb-3 ">
                    ...
                    <div class="col">
                        <label for="exampleFormControlInput">No KK :</label>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col">
                        ...
                        <label for="exampleFormControlInput">Alamat Asal :</label>
                        <input type="text" class="form-control"  value="{{ $surat->alamat}}" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
                        <label for="exampleFormControlInput">Alamat Tujuan :</label>
                        <input type="text" class="form-control"  value="{{ $surat->status_pernikahan}}" readonly>
                    </div>
                    <div class="col">
                        
                        <label for="exampleFormControlInput">Alasan Pindah :</label>
                        <input type="text" class="form-control"  value="{{ $surat->tujuan_surat}}" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
                        <label for="exampleFormControlInput">Jumlah Penikut/Keluarga Pindah :</label>
                        <input type="text" class="form-control"  value="{{ $surat->pengikut_pindah}}" readonly>
                    </div>
                </div>
