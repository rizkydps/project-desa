        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <div class="row mb-3 ">
                    ...
                    <div class="col">
                        <label for="exampleFormControlInput">Nama Kegiatan :</label>
                        <input type="text" class="form-control"  value="{{ $surat->tujuan_surat}}" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
                        <label for="exampleFormControlInput">Tanggal Kegiatan :</label>
                        <input type="text" class="form-control"  value="{{ $surat->tanggal}}" readonly>
                    </div>
                    <div class="col">
                        <label for="exampleFormControlInput">Alamat Kegiatan :</label>
                ...
                <div class="row mb-3 ">
                    <div class="col  mb-3">
                        <label for="exampleFormControlInput">Foto KTP Pemohon : </label>
                        <img src="{{ asset('storage/img/surat/ktp/'. $surat->foto_ktp )}}" class="img-fluid"style="width:300px; height:150px;" alt="">
                    </div>
                    <div class="col">
                        <label for="exampleFormControlInput">Foto Pengantar dari RT/Rw : </label>
