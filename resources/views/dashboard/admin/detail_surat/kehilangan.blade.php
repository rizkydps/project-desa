        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <div class="row mb-3 ">
                    ...
                    <div class="col">
                        <label for="exampleFormControlInput">Nama Barang Hilang :</label>
                        <input type="text" class="form-control"  value="{{ $surat->name }}" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col">
                        <label for="exampleFormControlInput">Foto Barang Yang Hilang : </label>
                        <img src="{{ asset('storage/img/surat/barang/'. $surat->foto_barang )}}" class="img-fluid"style="width:300px; height:150px;" alt="">
                    </div>
                </div>
                ...
                <div class="row mb-3 ">
                    ...
                    <div class="col">
                        <label for="exampleFormControlInput">Foto bpkb/stnk : </label>
                        <img src="{{ asset('storage/img/surat/bukti/'. $surat->foto_bukti )}}" class="img-fluid"style="width:300px; height:150px;" alt="">
                    </div>
                    <div class="col">
                        <label for="exampleFormControlInput">Foto Buku Tabungan : </label>
                        <img src="{{ asset('storage/img/surat/bukti/'. $surat->foto_bukti )}}" class="img-fluid"style="width:200px; height:250px;" alt="">
                    </div>
                </div>
