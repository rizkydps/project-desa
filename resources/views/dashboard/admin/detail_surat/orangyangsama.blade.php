    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <div class="row mb-3 ">
                    <div class="col">
                        <label for="exampleFormControlInput">Nama2 :</label>
                        <input type="text" class="form-control"  value="{{ $surat->name }}" readonly>
                    </div>
                    <div class="col">
                        <label for="exampleFormControlInput">NIK2 :</label>
                        <input type="text" class="form-control"  value="{{ $surat->nik }}" readonly>
                    </div>
                </div>
                <div class="row mb-3 ">
                    <div class="col">
                        <label for="exampleFormControlInput">Tempat Lahir2 :</label>
                        <input type="text" class="form-control"  value="{{ $surat->tempat_lahir }}" readonly>
                    </div>
                    <div class="col">
                        <label for="exampleFormControlInput">Tanggal Lahir2 :</label>
                        <input type="text" class="form-control"  value="{{ $surat->tanggal_lahir }}" readonly>
                    </div>
                </div>
                <div class="row mb-3 ">
                    <div class="col">
                        <label for="exampleFormControlInput">Jenis kelamin2 :</label>
                        <input type="text" class="form-control"  value="{{ $surat->jenis_kelamin }}" readonly>
                    </div>
                    <div class="col">
                        <label for="exampleFormControlInput">Pekerjaan2 :</label>
                        <input type="text" class="form-control"  value="{{ $surat->pekerjaan }}" readonly>
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="exampleFormControlInput">Alamat Sekarang2 :</label>
                        <input type="text" class="form-control"  value="{{ $surat->alamat}}" readonly>
                    </div>
                </div>
