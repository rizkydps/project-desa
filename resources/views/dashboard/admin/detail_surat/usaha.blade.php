    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="exampleFormControlInput">Nama Usaha :</label>
                        <input type="text" class="form-control"  value="{{ $surat->name}}" readonly>
                    </div>
                    <div class="col">
                        <label for="exampleFormControlInput">Tahun Mulai :</label>
                        <input type="text" class="form-control"  value="{{ $surat->tahun_mulai}}" readonly>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col">
                        <label for="exampleFormControlInput">Tujuan Usaha :</label>
                        <input type="text" class="form-control"  value="{{ $surat->tujuan_usaha}}" readonly>
                    </div>
                </div>
