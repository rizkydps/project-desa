    ...
    <div class="surat-wrapper">
        ...
        <div id="details" class="clearfix">
            <div id="lampiran">
                <div>Nomor: -</div>
                <div>Lampiran: -</div>
                <div class="address">Perihal: Surat Rekomendasi</div>
            </div>
        ...
        <div>
            Yang bertanda tangan dibawah ini Kepala Desa Sidomulyo, Kecamatan Anggana, Kabupaten Kutai Kartanegara memberikan rekomendasi kepada:
        </div>
        ...
        <br>
         <div>Surat Rekomendasi ini dibuat untuk...</div>
        <br>

        <div>Demikian surat ini dibuat dan diberikan kepada yang bersangkutan untuk digunakan sebagaimana mestinya.</div>
